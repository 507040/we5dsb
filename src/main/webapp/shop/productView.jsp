	        ...
	        <div class="col-12 mb-3 p-2" style="display: flex;flex-wrap: nowrap;height: auto;border: 1px solid gray;border-radius: 10px;">	                  
	            ...
	            <div class="row">
	           	<c:forEach items="<%=v %>" var="v">
		           	<form id="fmt" name="fmt" action="/cartProcess.pn" method="post">
				    	<input type="hidden" id="id" name="id" value="<%=session.getAttribute("id")%>">
				        <input type="hidden" name="pid" name="pid" value="${v.pId}">	   
				   </form>  
	           	<c:set value="${v.pId}" var="pid"/>           	
	                ...
	                <div class="col-md-7">
	                   ...
	                   <a class="btn btn-outline-info btn-sm" onclick="document.fmt.submit();">장바구니</a>
